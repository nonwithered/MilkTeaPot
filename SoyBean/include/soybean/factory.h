...
class BaseHandle {
 public:
  MilkTea_API void MilkTea_CALL ToRawHandle(SoyBean_Handle_t &handle);
...
class BaseFactory {
 public:
  MilkTea_API static MilkTea_Exception_t (* MilkTea_CALL Callback())(void *factory, SoyBean_Handle_t *handle);
