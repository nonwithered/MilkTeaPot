...
std::shared_ptr<SoyMilk::PlayerImpl> &soymilk_cast(SoyMilk_Player_t *self) {
  return *reinterpret_cast<std::shared_ptr<SoyMilk::PlayerImpl> *>(self);
}

SoyMilk_Player_t *soymilk_cast(std::shared_ptr<SoyMilk::PlayerImpl> &self) {
